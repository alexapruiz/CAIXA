...
arquivo_dir = open('c:\\projetos\\CAIXA\\scripts\\clearcase\\arquivos\\DIR_04.txt',mode='r',encoding='UTF-8')
arquivo_saida = open('c:\\projetos\\CAIXA\\scripts\\clearcase\\arquivos\\Verifica_Pastas_Vazias.csv',mode='w',encoding='UTF-8')

arquivo_saida.write(f"PASTA\n")
